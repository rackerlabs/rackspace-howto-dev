...
ca&rsquo;t expect to write to the same object 20 times per second, Cloud
...
closely-grouped data, meaning that yo&rsquo;re unlikely to need to divide it
...
deletion scripts.  Content grows regardless of the use case, so i&rsquo;s
