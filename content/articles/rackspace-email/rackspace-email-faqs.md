...
### [](){#Maximum mailbox}What is the maximum mailbox storage?

The maximum size of a Rackspace Email box is 25 GB.

^[back\\ to\\ top](#top)^

### [](){#Max attach}What is the maximum size for an attachment?

The maximum size for an attachment in the Rackspace environment is 50mb.

^[back\\ to\\ top](#top)^

### [](){#Email sig}How do I add a signature to my email?

You can find instructions for this in the article: [Adding a signature
to Rackspace
Email](/howto/adding-a-signature-to-rackspace-email)

^[back\\ to\\ top](#top)^

### [](){#add alias}How do I add an Alias?

You can find instructions for this in the article: [Adding an alias with
Rackspace
Email](/howto/adding-an-alias-with-rackspace-email)

^[back\\ to\\ top](#top)^

### [](){#group lists}How many group lists can I create?
...
### [](){#email online}How can I view my email online?
...
### [](){#IMAP & POP}What's the difference between IMAP and POP?
...
mail protocol
comparison](/howto/imap-and-pop-mail-protocol-comparison).
...
### [](){#billing}Where can I view my billing invoice?
...
### <span>[](){#Help!}Help! I'm locked out of my control panel!</span>
...
### [](){#purchase storage}How do I purchase more storage, mailboxes, licenses to my account?
...
### <span>[](){#admin account}How can I add an admin to my account? </span>
...
### <span>[](){#submit ticket}How do I submit a ticket?</span>
...
### <span>[](){#System status}How can I determine the Cloud Office system status?</span>
