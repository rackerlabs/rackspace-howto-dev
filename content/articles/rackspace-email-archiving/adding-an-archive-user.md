...
[](){#addOneuser}Add an archive user
------------------------------------
...
6.  Under **Permissions,** select the user type for the new user.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/4683.1.png){width="644"
    height="192"}
...
[](){#addMultipleusers}Add multiple archive users
-------------------------------------------------
...
[](){#editUsersettings}Edit archive user settings
-------------------------------------------------
