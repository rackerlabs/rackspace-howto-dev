...
to migrate a Linux server](/howto/prepare-to-migrate-a-linux-server)<span>.</span>
...
[](){#verifyServerisPatched}Verify that the server is fully patched
-------------------------------------------------------------------
...
[](){#checkBootStatus}Check the pending reboot status
-----------------------------------------------------
...
[](){#pruneOldData}Prune and archive old data
---------------------------------------------
...
[](){#truncateLog}Truncate the database log
-------------------------------------------
...
[](){#ensureAutoStart}Ensure that all critical services are set to start automatically
--------------------------------------------------------------------------------------
...
[](){#afterMigration}After the migration
----------------------------------------
