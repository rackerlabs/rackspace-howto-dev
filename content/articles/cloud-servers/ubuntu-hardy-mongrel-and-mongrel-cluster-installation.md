...
server](http://mongrel.rubyforge.org/ "http://mongrel.rubyforge.org/"){.external
.text}. Requests are proxied to the mongrel(s) from the main web server
(Apache, Nginx, etc).
