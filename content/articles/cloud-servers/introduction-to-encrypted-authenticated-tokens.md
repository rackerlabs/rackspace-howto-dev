...
[](){#top}Rackspace Cloud Identity supports tokens of
...
[](){#What are AE tokens}What is an AE token?
---------------------------------------------
...
[](){#What are UUID tokens}What is a UUID token?
------------------------------------------------
...
[](){#Difference between UUID and AE tokens}What is the difference between UUID and AE tokens?
----------------------------------------------------------------------------------------------
...
[](){#Best practices for handling authentication tokens}Best practices for handling authentication tokens
---------------------------------------------------------------------------------------------------------
...
-   To simplify authentication, credential, and token management, use
    ...
    application](https://wiki.openstack.org/wiki/OpenStackClients){.link} or
    one of the [Rackspace
    SDKs](https://developer.rackspace.com/sdks/){.link}.
