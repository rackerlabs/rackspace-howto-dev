...
-   MyRackspace also implements multi-factor authentication, but it is
    ...
    Authentication](/howto/myrackspace-two-factor-authentication "MyRackspace Two-Factor Authentication")*.
...
4.  []()On the Register SMS Device form, select the country code for the
    ...
    ![](/knowledge_center/sites/default/files/field/image/verify_code.png){width="290"
    height="200"}
...
4.  On the Account-wide two-factor authentication form, click the
    ...
    ![Update the account-wide multi-factor authentication
    enforcement setting.](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/mfa-required-setting_0.png){width="550"
    height="118"}
    ...
    ![Force user to log out when mulit-factor authentication requirement
    is
    not met.](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/mfa-force-logout.png){width="513"
    height="112"}
...
requirement](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/mfa-setup-required.png){height="212"}**
...
1.  Log in to the [Rackspace Cloud Control
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/control_panel_login.png){width="362"
    height="206"}
    ...
    authentication](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/mfa_passcode.png){width="366"
    height="207"}
    ...
    ![OTP device with generated passcode for use with one-time
    password authentication.](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/OTP-device.png){width="360"
    height="189"}
...
2.  When prompted, type the passcode in the **Passcode** field on the
    ...
    mobile device registered to Rackspace
    Cloud account.](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/enter_mfa_passcode.png){width="439"
    height="250"}
