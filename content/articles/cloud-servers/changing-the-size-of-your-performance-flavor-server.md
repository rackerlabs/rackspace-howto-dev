...
-   [Increase Available Storage with Cloud Block
    Storage](/howto/upgrading-resources-for-general-purpose-or-io-optimized-cloud-servers)
-   [Create a new server with more
    resources](/howto/upgrading-resources-for-general-purpose-or-io-optimized-cloud-servers)
...
1.  Create an image of your system disk. (See [Create an image or
    ...
    image](/howto/create-an-image-of-a-server-and-restore-a-server-from-a-saved-image) for
    more information.)
...
optimized servers](/howto/rackspace-auto-scale-tips-and-how-tos).
