...
permalink: article/rackconnect-v30-api
type: article
...
sample](/knowledge_center/sites/default/files/field/image/RCv3_apiary_show_code_sample.png)
...
-   The examples use the Cloud Identity Service API US endpoint of
    ...
    LON region, you should use the UK endpoint of
