...
![RackConnect v3.0 apiary show code
sample](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/RCv3_apiary_show_code_sample.png){width="700"}
...
<span>[](){#section1_use_cloud_identity_to_obtain_auth}Use</span><span> Cloud Identity to obtain an authentication token</span>
-------------------------------------------------------------------------------------------------------------------------------
...
### **[](){#1_cloud_identity_req_API_key}**Cloud Identity Service request for an auth token ID using your cloud account's API key
...
### **[](){#2_cloud_identity_req_cloud_password}**Cloud Identity Service request for an authentication token ID using your cloud account's password
...
### **[](){#3_Example_JSON_response}**Example JSON response to a Cloud Identity Service request
...
<span>[](){#section2_manage_IP_addresses_API}Manage IP addresses using the API</span>
-------------------------------------------------------------------------------------
...
### **[](){#4_RackConnect_v3_endpoint}**RackConnect v3.0 endpoint
...
### **[](){#5_list_public_IP_API_call}**List public IP address for a cloud server API request
...
### **[](){#6_example_response_list_public_IP}**Example response from list public IP address for a cloud server API request
...
<span>[](){#section3_add_public_IP_address_API}Add a public IP address using the API</span>
-------------------------------------------------------------------------------------------

Use the following operation to add a public IP address to your
RackConnect v3.0 cloud server.

### **[](){#7_add_provision_IP_API}**Add or provision a public IP address to a cloud server API request
...
### **[](){#8_example_response_add_provision_IP_API_call}**Example response to the add or provision a public IP address to a cloud server API request
...
<span>[](){#section4_remove_public_IP_address_API}Remove a public IP address using the API</span>
-------------------------------------------------------------------------------------------------

Use the following operation to remove a public IP address from a cloud
server.

### **[](){#9_remove_public_IP_API}**Remove a public IP address from a cloud server API request
...
### **[](){#10_example_204_response_remove_IP_API}**Example 204 response to the remove a public IP address from a cloud server API request
...
[](){#section5_examples_with_sample_data}Examples with sample data
------------------------------------------------------------------
...
### **[](){#11_list_public_IP_API_with_sample_data}**List public IP address for a cloud server API request with sample data
...
### **[](){#12_sample_data_entries}**Sample data entries for this example are as follows:
