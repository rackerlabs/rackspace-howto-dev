...
7.  Click **Create Template**.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-customized-template1.png){width="513"
    height="297"}
...
10. Click **Create Stack**.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-create-stack-building.png){width="449"
    height="380"}
...
![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-metrics-up1.png){width="408"
height="616"}
...
4.  Type the username and password you were presented with after
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-home-page_0.png){width="432"
    height="244"}
...
for the
Cloud](/howto/getting-started-with-rackspace-intelligence-for-the-cloud), [Monitoring
entities with Rackspace
Intelligence](/howto/monitoring-entities-with-rackspace-intelligence),
and [Working with
...
2.  Modify the JSON to match your instance by replacing all the
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-replace-entty-id1.png){width="639"
    height="76"}
3.  On the Grafana dashboard, click **Import** on the top-right corner,
    click **Browse**, and then upload the file to Grafana.

    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-JSON-file-upload.png){width="432"
    height="184"}

    The dashboard automatically appears and displays your MySQL database
    instances.

    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/grafana-mysql-data.png){width="428"
    height="337"}
...
cloud](/howto/getting-started-with-rackspace-intelligence-for-the-cloud).
