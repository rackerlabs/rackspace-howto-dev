...
-   Existing mail data does not migrate with Directory Sync to our
    ...
    services](/howto/email-migration-services) article.
...
configure](/howto/rackspace-directory-sync-install-and-configure)
...
### [Password synchronization](){#password sync}
...
### [Distribution list membership synchronization](){#dl member sync}
...
### [Exchange contacts](){#exchange contacts}
...
### [Alternate email addresses (Optional Synchronization)](){#alternate address sync}
