...
![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/Basic_a.png){height="250"}

### **[](){#Managepublicfolders}Manage your public folders**
...
8.  Click **Save** to create the folder.
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/Create_a.png){height="250"}
...
1.  In the list on the Folders page, click the gear icon next to the
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/delete_a.png){height="250"}
2.  From the menu, select **Delete**.
3.  In the confirmation pop up box, click **Delete Folder**, to
    permanently delete the folder.

### **[](){#bulkfolderdelete}Bulk-delete folders**
...
2.  Click the gear icon next to the **Folder Name** label at the top of
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/bulk%20delete2.png){height="250"}
...
3.  Click **Rename**.
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/rename_a.png){height="250"}

### **[](){#publicfolderchildsubfolderview}View and create subfolders (child folders)**
...
![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/child%20subfolder.png){width="500"}
...
### **[](){#createsubfolerinparent}Create a subfolder from the parent folder's page**
...
#### **[](){#ceatesubfolderfrompubliclisting}Create a subfolder from public folder listing page**
...
#### **[](){#createsubfolderfromchildsublisting}Create a subfolder from the subfolder list page**
...
![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/subfolders2_a.png){height="250"}
...
![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/search.png){width="500"}
...
2010](/howto/working-with-public-folders-through-outlook-for-exchange-2007-and-2010)
