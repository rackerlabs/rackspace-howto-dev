...
### [](){#whatis}What is seamless sign-on (SSO)?
...
### [](){#permissions}What permissions do I have when using SSO?
...
### [](){#mapping}How do MyRackspace permissions map to Cloud Control Panel permissions?
...
### [](){#changepermissions}How are user permissions set or changed for SSO?
...
### [](){#linkback}Can I link back to MyRackspace from the Cloud Control Panel?
...
### [](){#seamless}Can I log in to the Cloud Control Panel and seamlessly link to and be logged in to MyRackspace?

No, not at this time.

([back to top](#top))

### [](){#manageeverything}Can I manage all my tickets, billing, and users in one place now?
...
### [](){#metadata}How do I add or modify metadata?
...
1.  Use the Nova Client to issue these commands. The Nova Client can be
    ...
    reference](/howto/useful-python-novaclient-commands)
...
### [](){#limitations}What are the limitations of SSO?
