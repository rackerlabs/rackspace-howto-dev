...
1.  Login to the [<span class="external text">Cloud Sites Control
    ...
    website](/howto/getting-started-with-cloud-sites-how-to-add-a-new-website).</span>
...
6.  Next create a new Mysql database (e.g. *prefix*\_wp20) with
    ...
    Sites](/howto/using-cloud-databases-with-your-cloud-site).
...
-   [More about Word
    Press](http://wordpress.org/download/ "http://wordpress.org/download/"){.external
    .text}
