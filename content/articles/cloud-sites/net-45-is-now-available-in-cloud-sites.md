...
![](http://www.rackspace.com/knowledge_center/sites/default/files/field/image/Selection_001_0.png){width="702"
height="287"}

Next select the appropriate .NET 4.5 option and click **Change
Technology**.

![](http://www.rackspace.com/knowledge_center/sites/default/files/field/image/Selection_003_0.png){width="694"
height="137"}
