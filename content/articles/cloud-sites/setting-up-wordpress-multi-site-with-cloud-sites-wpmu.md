...
-   [Getting started with Cloud
    Databases](/howto/cloud-databases)
-   [Using Cloud Databases with your Cloud
    Site](/howto/using-cloud-databases-with-your-cloud-site)
...
-   [Installing WordPress on Cloud
    Sites](/howto/installing-wordpress-on-cloud-sites)

**Note:** For this specific installation, we do not recommend the use of
the one-click installer.

![wp-db-configuration-screen](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_DB_configuration.PNG){width="447"
height="335"}
...
already set this way. For example: **http://example.com**e.
 ...
 ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_url_configuration.PNG){width="290"
height="18"}
...
1.  In WordPress, go to the admin area, click the **Tools** menu, and
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_networksetup_menu.PNG){width="159"
    height="156"}
...
3.  a.  Under **Addresses of Sites in your Network**, select
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_networksetup_0.PNG){width="656"
    height="496"}
...
1.  Go to **My Sites &gt; Network Admin &gt; Plugins**.
    ...
    **![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/wpmu-menuhighlighted.png){width="157"
    height="228"}**
...
4.  Click **Install Now**.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_MultidomainPluginInstall.PNG){width="783"
    height="136"}
...
5.  Under **Domain Options**, select check boxes 2 and 3 only (ensure
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/dmapping-settings_0.png){width="680"
    height="415"}
...
2.  Click **Add New**.
    ...
    **![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_SiteConfiguration.PNG){width="921"
    height="178"}**

3.  Enter the information for the site that you want to add to
    the network.

    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_addnewsite.PNG){width="381"
    height="258"}
...
7.  Note the number that follows after **?id=**. This is the site's
    **ID** number, and you will need it in the next steps.
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_siteidURL.PNG){width="345"
    height="22"}
...
10. Clear the **Primary** check box.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/WP_NewDomainID.PNG){width="247"
    height="261"}
