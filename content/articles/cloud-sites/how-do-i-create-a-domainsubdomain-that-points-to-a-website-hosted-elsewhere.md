...
2.  Create the new domain or subdomain under the correct account. If you
    ...
    Cloud Sites: How To Add A New Website](/howto/getting-started-with-cloud-sites-how-to-add-a-new-website).
3.  After the domain or subdomain is set up in your account, add a PHP
    ...
    Cloud Sites, FTP/SSHFS/FTP Clients](/howto/getting-started-with-cloud-sites-ftpsshfsftp-clients).
