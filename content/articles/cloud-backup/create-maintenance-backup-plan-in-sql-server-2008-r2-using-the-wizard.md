...
1.  On the server, open the **Run** dialog box, type in **services.msc**
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/CheckSQLServerAgent1.png){width="429"
    height="225"}
2.  Find the SQL Server Agent service in the list and double-click it.

    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/CheckSQLServerAgent2.png){width="727"
    height="321"}
...
4.  On the **General** tab, select **Automatic** as the startup type,
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/CheckSQLServerAgent3.png){width="439"
    height="188"}
...
2.  In the Object Explorer pane, go to **Management** &gt; **Maintenance
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/CreatingtheMaintenancePlan1_0.png){width="408"
    height="587"}
...
5.  On the Select Maintenance Tasks page, select the **Back Up
    ...
    **Next**.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/Creatingthemaintenanceplan4.png){width="576"
    height="512"}
...
6.  To configure the scheduling options for this task, click **Change**
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/fullbackupsetttings1.png){width="589"
    height="941"}
...
10. Under **Duration**, adjust the **Start** and **End** dates. In the
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/fullbackupsetttings2.png){width="680"
    height="591"}
...
11. Under **Duration**, adjust the **Start date** and **End date**
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogBackupSettings2.png){width="594"
    height="518"}
12. Click **OK**.
...
4.  Right-click on the **Maintenance Cleanup Task** and choose
    **Edit**.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogCleanupTask2.png){width="278"
    height="150"}
...
10. Select the **Delete files based on the age of the file at task run
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogCleanupTask3.png){width="484"
    height="566"}
...
13. Double-click the connected green line.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogCleanupTask4.png){width="353"
    height="287"}
...
14. In the Precedence Constraint Editor, set Value to Completion.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogCleanupTask5.png){width="445"
    height="370"}

15. Click **OK** to return to the Management Studio main window.
    The line should now appear blue.

    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/TransactionLogCleanupTask6.png){width="366"
    height="309"}
...
1.  In the Object Explorer pane, right-click the failed subplan and
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/Errors2_0.png){width="604"
    height="320"}
...
2.  Click the row for the failed job.
    ...
    ![](https://8026b2e3760e2433679c-fffceaebb8c6ee053c935e8915a3fbe7.ssl.cf2.rackcdn.com/field/image/Errors3.png){width="991"
    height="425"}
